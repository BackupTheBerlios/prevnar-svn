{
This is a modified component from UTF8Tools by Jan Behrens, FlexiGuided GmbH, Berlin
http://wiki.freepascal.org/Theodp
License information about UTF8Tools is given in utf8proc_LICENSE
}
...
type
  TUniStreamTypes = (ufUndefined=-1,ufUtf8=0, ufANSI=1, ufUtf16be=2, ufUtf16le=3, ufUtf32be=4, ufUtf32le=5);
